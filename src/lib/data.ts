...
export const profile = {
  ...
  ctaPrimary: { label: "Explore the Worlds", href: "/#case-studies" },
...
// The homepage deliberately shows no metrics — verified numbers live inside
// each world (see plansee.ts), never on the gateway.
...
export const caseStudies: CaseStudy[] = [
  {
    ...
    oneLiner:
      "How an unformed marketing function became a measurable, sales-aligned growth system for an interior design and finishing company.",
    status: "live",
